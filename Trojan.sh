...
EOF
	...
	wget https://github.com/9211314/trojan/raw/master/web.zip
    	unzip web.zip
...
EOF
	...
	green "======================================================================"
	green "Trojan 已安装完成，请使用以下链接下载 Trojan 客户端，此客户端已配置好所有参数"
	green "1、复制下面的链接，在浏览器打开，下载客户端"
	yellow "http://${your_domain}/$trojan_path/trojan-cli.zip"
	red "请记录下面规则网址"
	yellow "http://${your_domain}/trojan.txt"
	green "2、将下载的压缩包解压，打开文件夹，运行 start.bat 即打开并运行Trojan客户端"
	green "3、运行 stop.bat 即关闭 Trojan 客户端"
	green "4、Trojan 客户端需要搭配浏览器插件使用，例如 SwitchyOmega 等"
	green "访问  https://www.woai.it/11.html ‎ 了解详情"
	green "======================================================================"
	else
    red "================================"
...
start_menu(){
    ...
    green " 网站：https://www.woai.it/"
    green " 此脚本集成了 BBR PLUS 加速 "
    green " ===================================="
    echo
    red " ===================================="
    yellow " 1. 一键安装 Trojan"
    red " ===================================="
    yellow " 2. 安装 4 IN 1 BBR PLUS 加速脚本"
    red " ===================================="
